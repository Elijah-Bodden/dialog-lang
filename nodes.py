...
class Statement:
    def __init__(self, type: str, line: int, col: int, program: str):
        self.type = type
        self.line = line
        self.col = col
        self.program = program
...
class PrintStatement(Statement):
    def __init__(self, expr: Expression, line: int, col: int, program: str):
...
class WhileStatement(Statement):
    def __init__(self, condition: Expression, block: BlockStatement, line: int, col: int, program: str):
...
class ForStatement(Statement):
    def __init__(self, condition: Expression, block: BlockStatement, modifier_statement: Statement, line: int, col: int, program: str):
...
class AssignmentStatement(Statement):
    def __init__(self, identifier: str, expr: Expression, asssignment_type=None, line=0, col=0, program=""):
...
class IfStatement(Statement):
    def __init__(self, condition: Expression, block: BlockStatement, else_statement=None, line=0, col=0, program=""):
    ...
    def __str__(self):
        return f"IF ({self.condition}) THEN {self.block}" + (self.else_statement.pretty_string(0) if self.else_statement else "")


class ElseStatement(Statement):
    # Else statements can have a condition (elif) and a follow-up else, if so
    def __init__(self, block: BlockStatement, condition=None, follow_up_else=None, line=0, col=0, program=""):
